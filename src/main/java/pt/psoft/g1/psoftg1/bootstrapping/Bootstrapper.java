...
public class Bootstrapper implements CommandLineRunner {
    ...
    private void createAuthors() {
        if (authorRepository.searchByNameName("Manuel Antonio Pina").isEmpty()) {
            ...
            final Author author = new Author(id, "Manuel Antonio Pina",
        ...
        if (authorRepository.searchByNameName("Antoine de Saint Exupéry").isEmpty()) {
            ...
            final Author author = new Author(id, "Antoine de Saint Exupéry",
        ...
        if (authorRepository.searchByNameName("Alexandre Pereira").isEmpty()) {
            ...
            final Author author = new Author(id, "Alexandre Pereira",
        ...
        if (authorRepository.searchByNameName("Filipe Portela").isEmpty()) {
            ...
            final Author author = new Author(id, "Filipe Portela",
        ...
        if (authorRepository.searchByNameName("Ricardo Queirós").isEmpty()) {
            ...
            final Author author = new Author(id, "Ricardo Queirós",
        ...
        if (authorRepository.searchByNameName("Freida Mcfadden").isEmpty()) {
            ...
            final Author author = new Author(id, "Freida Mcfadden",
        ...
        if (authorRepository.searchByNameName("J R R Tolkien").isEmpty()) {
            ...
            final Author author = new Author(id, "J R R Tolkien",
        ...
        if (authorRepository.searchByNameName("Gardner Dozois").isEmpty()) {
            ...
            final Author author = new Author(id, "Gardner Dozois",
        ...
        if (authorRepository.searchByNameName("Lisa Tuttle").isEmpty()) {
            ...
            final Author author = new Author(id, "Lisa Tuttle",
    ...
    protected void createBooks() {
        ...
        if (bookRepository.findByIsbn("9789720706386").isEmpty()) {
            ...
            if (genre.isPresent() && !author.isEmpty()) {
                ...
                Book book = new Book(id,"9789720706386",
        ...
        if (bookRepository.findByIsbn("9789723716160").isEmpty()) {
            ...
            if (genre.isPresent() && !author.isEmpty()) {
                ...
                authors.add(author.get(0));
                Book book = new Book(id,"9789723716160",
        ...
        if (bookRepository.findByIsbn("9789895612864").isEmpty()) {
            ...
            if (genre.isPresent() && !author.isEmpty()) {
                ...
                authors.add(author.get(0));
                Book book = new Book(id,"9789895612864",
                        "C e Algoritmos",
        ...
        if (bookRepository.findByIsbn("9782722203402").isEmpty()) {
            ...
            if (genre.isPresent() && !author.isEmpty() && !author2.isEmpty()) {
                ...
                Book book = new Book(id,"9782722203402",
        ...
        if (bookRepository.findByIsbn("9789722328296").isEmpty()) {
            ...
            if (genre.isPresent() && !author.isEmpty()) {
                ...
                authors.add(author.get(0));
                Book book = new Book(id,"9789722328296",
                        "O Principezinho",
        ...
        if (bookRepository.findByIsbn("9789895702756").isEmpty()) {
            ...
            if (genre.isPresent() && !author.isEmpty()) {
                ...
                authors.add(author.get(0));
                Book book = new Book(id,"9789895702756",
                        "A Criada Está a Ver",
        ...
        if (bookRepository.findByIsbn("9789897776090").isEmpty()) {
            ...
            if (genre.isPresent() && !author.isEmpty()) {
                String id = idGenerator.generateId();
                authors.add(author.get(0));
                Book book = new Book(id,"9789897776090",
                        "O Hobbit",
        ...
        if (bookRepository.findByIsbn("9789896379636").isEmpty()) {
            ...
            if (genre.isPresent() && !author.isEmpty() && !author2.isEmpty()) {
                ...
                authors.add(author.get(0));
                authors.add(author2.get(0));
                Book book = new Book(id,"9789896379636",
        ...
        if (bookRepository.findByIsbn("9789896378905").isEmpty()) {
            ...
            if (genre.isPresent() && !author.isEmpty() && !author2.isEmpty()) {
                ...
                Book book = new Book(id,"9789896378905",
        ...
        if (bookRepository.findByIsbn("9789896375225").isEmpty()) {
            ...
            if (genre.isPresent() && !author.isEmpty() && !author2.isEmpty()) {
                ...
                Book book = new Book(id,"9789896375225",
                        "Windhaven",
    ...
    private void createLendings() {
        ...
        // Agora já é seguro usar books.get() e readers.get()
        LocalDate startDate;
        ...
        for (i = 0; i < 3; i++) {
            ...
            if (lendingRepository.findByLendingNumber("2024/" + seq).isEmpty()) {
                ...
                lending = Lending.newBootstrappingLending(
                        books.get(i), readers.get(i * 2), 2024, seq,
                        startDate, returnedDate, lendingDurationInDays, fineValuePerDayInCents);
        ...
        for (i = 0; i < 3; i++) {
            ...
            if (lendingRepository.findByLendingNumber("2024/" + seq).isEmpty()) {
                ...
                lending = Lending.newBootstrappingLending(
                        books.get(1 + i), readers.get(1 + i * 2), 2024, seq,
                        startDate, null, lendingDurationInDays, fineValuePerDayInCents);
                lendingRepository.save(lending);
            }
        }
        ...
        for (i = 0; i < 3; i++) {
            ...
            if (lendingRepository.findByLendingNumber("2024/" + seq).isEmpty()) {
                ...
                lending = Lending.newBootstrappingLending(
                        books.get(3 / (i + 1)), readers.get(i * 2), 2024, seq,
                        startDate, null, lendingDurationInDays, fineValuePerDayInCents);
                lendingRepository.save(lending);
            }
        }
        ...
        for (i = 0; i < 3; i++) {
            ...
            if (lendingRepository.findByLendingNumber("2024/" + seq).isEmpty()) {
                ...
                lending = Lending.newBootstrappingLending(books.get(3 - i), readers.get(1 + i * 2), 2024, seq,
                        startDate, returnedDate, lendingDurationInDays, fineValuePerDayInCents);
                lendingRepository.save(lending);
            }
        }
        ...
        for (i = 0; i < 6; i++) {
            ...
            if (lendingRepository.findByLendingNumber("2024/" + seq).isEmpty()) {
                ...
                lending = Lending.newBootstrappingLending(books.get(i), readers.get(i), 2024, seq, startDate,
                        returnedDate, lendingDurationInDays, fineValuePerDayInCents);
                lendingRepository.save(lending);
            }
        }
        ...
        for (i = 0; i < 6; i++) {
            ...
            if (lendingRepository.findByLendingNumber("2024/" + seq).isEmpty()) {
                ...
                lending = Lending.newBootstrappingLending(books.get(i), readers.get(1 + i % 4), 2024, seq, startDate,
                        returnedDate, lendingDurationInDays, fineValuePerDayInCents);
                lendingRepository.save(lending);
            }
        }
        ...
        for (i = 0; i < 6; i++) {
            ...
            if (lendingRepository.findByLendingNumber("2024/" + seq).isEmpty()) {
                ...
                lending = Lending.newBootstrappingLending(books.get(i), readers.get(i % 2 + 2), 2024, seq, startDate,
                        returnedDate, lendingDurationInDays, fineValuePerDayInCents);
                lendingRepository.save(lending);
            }
        }
        ...
        for (i = 0; i < 6; i++) {
            ...
            if (lendingRepository.findByLendingNumber("2024/" + seq).isEmpty()) {
                ...
                lending = Lending.newBootstrappingLending(books.get(i), readers.get(i % 2 + 3), 2024, seq, startDate,
                        null, lendingDurationInDays, fineValuePerDayInCents);
                lendingRepository.save(lending);
            }
        }
        ...
        for (i = 0; i < 10; i++) {
            ...
            if (lendingRepository.findByLendingNumber("2024/" + seq).isEmpty()) {
                ...
                lending = Lending.newBootstrappingLending(books.get(i), readers.get(4 - i % 4), 2024, seq, startDate,
                        null, lendingDurationInDays, fineValuePerDayInCents);
                lendingRepository.save(lending);
            }
        }
