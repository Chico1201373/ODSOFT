...
class GenreRepositoryIT {
    ...
    @Test
    void getLendingsPerMonthLastYearByGenre_returnsData_whenExists() {
        Genre genre = new Genre("Drama");
        em.persist(genre);
        em.flush();

        pt.psoft.g1.psoftg1.authormanagement.model.Author author = new pt.psoft.g1.psoftg1.authormanagement.model.Author(
                "AUTH1", "Author Name", "Bio", "photo");
        em.persist(author);

        pt.psoft.g1.psoftg1.bookmanagement.model.Book book = new pt.psoft.g1.psoftg1.bookmanagement.model.Book(
                "book1",
                "9783161484100",
                "Title 1",
                "desc",
        ...
        pt.psoft.g1.psoftg1.usermanagement.model.Reader reader = pt.psoft.g1.psoftg1.usermanagement.model.Reader
                .newReader("u1@example.com", "Password1!", "name");
        ...
        // create two lendings for last month
        LocalDate now = LocalDate.now();
        LocalDate lastMonth = now.minusMonths(1);

        pt.psoft.g1.psoftg1.lendingmanagement.model.Lending l1 = pt.psoft.g1.psoftg1.lendingmanagement.model.Lending
                .newBootstrappingLending(
                        book, readerDetails, lastMonth.getYear(), 1, lastMonth, null, 7, 0);

        pt.psoft.g1.psoftg1.lendingmanagement.model.Lending l2 = pt.psoft.g1.psoftg1.lendingmanagement.model.Lending
                .newBootstrappingLending(
                        book, readerDetails, lastMonth.getYear(), 2, lastMonth.plusDays(1), null, 7, 0);
        ...
        // we expect at least one entry for lastMonth with our genre and count 2
        boolean found = res.stream()
                .anyMatch(dto -> dto.getYear() == lastMonth.getYear() && dto.getMonth() == lastMonth.getMonthValue() &&
                        dto.getValues().stream().anyMatch(
                                v -> v.getGenre().equals("Drama") && ((Number) v.getValue()).longValue() == 2L));

        assertTrue(found, "Expected lendings aggregation for Drama in lastMonth with count 2");
    }
